...
class Day01Test : AbstractPuzzleSolverTest(Day1, 514579, 241861950)
class Day02Test : AbstractPuzzleSolverTest(Day2, 2, 1)
class Day03Test : AbstractPuzzleSolverTest(Day3, 7, 336L)
